...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGoogleMaps-1.1.0-beta.12.xcframework.zip",
			checksum: "19148bc82d87deaaa0304e08bc5a8c8efa37c565acafa9cf170cd8745f5eeb6a"
		)
	]
)