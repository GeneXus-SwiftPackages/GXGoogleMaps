...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGoogleMaps-1.4.0-beta.6.xcframework.zip",
			checksum: "b4424ad1b1987852703103982fc85003523d10383dba50aeb17ad0fa6d445968"
		)
	]
)