...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGoogleMaps-1.0.0-beta+20230316142352.xcframework.zip",
			checksum: "35334a96b4b1e6554e4414098bd42587e1df60980b6ffbeab6cf676ff8aac2ea"
		)
	]
)