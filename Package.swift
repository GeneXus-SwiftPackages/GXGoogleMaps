...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGoogleMaps-1.0.0-beta.20230711133237.xcframework.zip",
			checksum: "4c45e6f3a5db2a7e1f9d4999e528fc8e3b336921d0cc7e5799dbfab0b9647286"
		)
	]
)