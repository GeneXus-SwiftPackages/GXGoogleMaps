...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGoogleMaps-1.0.0-beta.20230613192339.xcframework.zip",
			checksum: "b01a85ae8cd3065a2b93b9aff86488fb0cb6bbc59d747c05ac192df3f51234fa"
		)
	]
)