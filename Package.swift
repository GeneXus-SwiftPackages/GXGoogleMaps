...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGoogleMaps-1.1.0-beta.7.xcframework.zip",
			checksum: "a1eee13b7ff067bba81539eba920cf3b848b59943808d85614f248c3a22b0e61"
		)
	]
)