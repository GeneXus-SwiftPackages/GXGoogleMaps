...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGoogleMaps-1.0.0-beta.20230627202653.xcframework.zip",
			checksum: "1fa361ed4a6998da059a131a081c819a0a0cfa857bb9f8c8be10f6b54dc92804"
		)
	]
)