...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGoogleMaps-1.2.0-beta.24.xcframework.zip",
			checksum: "76103b1a50281dbfb6b21d42665edf7ba666ff40bbb02b721a169d914101fda4"
		)
	]
)