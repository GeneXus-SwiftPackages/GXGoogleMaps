...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGoogleMaps-1.0.0-beta+20230502131235.xcframework.zip",
			checksum: "eaf0a556fc7e3afeefb5502384523b49d722c2932f1f415cb3d924b4087787f5"
		)
	]
)