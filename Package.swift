...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGoogleMaps-2.0.0-beta.27.xcframework.zip",
			checksum: "02edeaf04c0214aeb87e5a05ec1119dd86320fd8d48fdf821c7cf106aba1f193"
		)
	]
)