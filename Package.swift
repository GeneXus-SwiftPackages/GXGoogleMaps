...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGoogleMaps-1.0.0-beta+20230323132058.xcframework.zip",
			checksum: "85012bf1f6bf02ef0c72f52f240ab35589f2b3ffdb26d65faf5fff93b3d0b59f"
		)
	]
)