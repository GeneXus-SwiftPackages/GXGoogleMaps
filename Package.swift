...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXGoogleMaps-2.0.0-rc.36.xcframework.zip",
			checksum: "9e1daa498e5ba713d08527121d04b15b4880a1067f145fb7e13a7f67dc71440d"
		)
	]
)