...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGoogleMaps-1.0.0-beta+20230531050040.xcframework.zip",
			checksum: "0f583d9dcecb4b30b5eda4e2c697ece8b47315495fcbd7bb72f089d800368cce"
		)
	]
)