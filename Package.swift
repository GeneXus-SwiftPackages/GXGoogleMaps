...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGoogleMaps-1.2.0-beta.16.xcframework.zip",
			checksum: "5f6275d17d3a4f6fa9fa74730571c3214305076929edfead3bd7a3e82ba7ee18"
		)
	]
)