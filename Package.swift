...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/releases/GXGoogleMaps-1.1.0-rc.1.xcframework.zip",
			checksum: "c36df68a5bc2ed065e2fffd428a985793d30d4d873e464611404a1d13611c569"
		)
	]
)