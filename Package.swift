...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGoogleMaps-1.0.0-beta+20230504210908.xcframework.zip",
			checksum: "fcdc5fde99aa91298d53cb2142bea80d3d63bec436ca0c70f829841d826a2078"
		)
	]
)