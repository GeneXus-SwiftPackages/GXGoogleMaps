...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGoogleMaps-1.0.0-beta+20230328162416.xcframework.zip",
			checksum: "edae50e932148c62461fc56e44cbbb21f797e1de95f2ab0005efd1756f440420"
		)
	]
)