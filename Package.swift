...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGoogleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGoogleMaps-1.0.0-beta+20230309100338.xcframework.zip",
			checksum: "ae3ee3fadb14a74db84b6ce988f0cc0fefc9238ee199bf799f86470d416e5de4"
		)
	]
)